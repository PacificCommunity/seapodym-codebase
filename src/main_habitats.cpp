...
int seapodym_habitats(const char* parfile, const int cmp_regime, const int sub_option, const int sub_option2, const bool reset_buffers);
...
//		help(argv[0]);
	...
	return seapodym_habitats(argv[argc-1],cmp_regime,sub_option,sub_option2,reset_buffers);
}
