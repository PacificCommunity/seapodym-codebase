...
//     voir Fournier et Sibert (1994) pour le calcul d�taill�
...
//	l'argument sp permet de definir l'espece :ex: 0 skj, 1, yft...
///////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
// AVERTISSEMENT !! Les fonction caldia et calrec ont ete developpees sous fortran 
// et utilisent l'ordre d'incrementation i pour colonnes (longitudes) et j pour
// lignes (latitudes). 
// Les matrices sont donc lues dans le sens fortran et ecrites dans dans le sens C
////////////////////////////////////////////////////////////////////////////////
...
//cout << i << " " << j << " " << std::tolower(pos) << " " << map.bord_cell[i][j] << endl;				
...
double CCalpop::d1(const char pos, const double sigmam, const double sigma, const double uinf, 
...
double CCalpop::d2(const char pos, const double sigmam, const double sigma, const double sigmap, 
					const double u, const double twodd, const double dd, const double d, const int dt)
{
	double value = 0;
	switch (pos){
	        case SANS:
			if (u > 0)
				value = ((sigmam+2*sigma+sigmap)/twodd)
					+(u/d) + dt;
			else
				value = ((sigmam+2*sigma+sigmap)/twodd)
					-(u/d) + dt;
...
double CCalpop::d3(const char pos, const double sigma, const double sigmap, const double usup,
					const double twodd, const double dd, const double d){
	double value = 0;
    	switch (pos) {
        	case SANS:
