...
*/
void PMap::definit_cell_bords(const int nti, const int ntj) // d�finition des bords des cellules de la zone
{
  ...
  //***********************
  // Cadre de la grille 
  // Definition des cot�s des cellules situ�es aux bords de la grille
  //***********************
