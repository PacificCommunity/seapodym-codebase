...
void dfxbet_juv_comp(
    dmatrix& dfbm, dmatrix& dfxbet, dmatrix& dfw, const dmatrix a,
    const dmatrix bm, const dmatrix c, unsigned long int pos_map,
    const int maxn, const int dt);
void dfxbet_adult_comp(
    dmatrix& dfa, dmatrix& dfbm, dmatrix& dfc, dmatrix& dfxbet, dmatrix& dfw,
