...
// fonction qui retourne la valeur de correlation lineaire entre deux matrices
...
// (returned as corr), the significance level at which the null hypothesis of zero
