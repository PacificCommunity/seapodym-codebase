...
class SeapodymDocConsole {
   ...
   public:
    ...
    int nlon_input,
        nlat_input;  // different resolution of input fields, used in
                     // seapodym_habitats and seapodym_densities only
    ...
    int t_series;  // nombre de pas de temps dans la serie (remis a zero chaque
                   // boucle du spinup)
