...
//	void SumByArea(const PMap& map, const dmatrix& mask_catch, const dmatrix& mat2d, dvector& sum_area, const dvector cell_area_corr, const int nb_reg, const int nbt, const int sp);
//	void SumByEEZ(const CParam& param, const PMap& map, const DMATRIX& mat2d, DVECTOR& sum_EEZ, const dvector cell_area_corr);
	void SumByArea(const PMap& map, const dmatrix& mask_catch, const dmatrix& mat2d, dvector& sum_area, const dvector cell_area, const int nb_reg, const int nbt);
        void SumByEEZ(const CParam& param, const PMap& map, const DMATRIX& mat2d, DVECTOR& sum_EEZ, const dvector cell_area);
